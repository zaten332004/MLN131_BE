        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    QuestionKey = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PathFirst = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    VisitSessionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PageViewEvents_VisitSessions_VisitSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PageViewEvents_OccurredAt",
                table: "PageViewEvents",
                column: "OccurredAt");

            migrationBuilder.CreateIndex(
                name: "IX_PageViewEvents_VisitSessionId",
                table: "PageViewEvents",
                column: "VisitSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserResponses_UserId_CreatedAt",
                table: "UserResponses",
                columns: new[] { "UserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_VisitSessions_LastSeenAt",
                table: "VisitSessions",
                column: "LastSeenAt");

            migrationBuilder.CreateIndex(
                name: "IX_VisitSessions_StartedAt",
                table: "VisitSessions",
                column: "StartedAt");
